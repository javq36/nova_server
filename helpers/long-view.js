export const longView =  `SELECT  b.serie AS Vin, CONVERT(numeric(10, 0), DD.costo_unitario) AS costocompra, b.precio_lista AS costoactual, b.modelo_ano AS Ano_Modelo, DATEDIFF(day, f.fecha, GETDATE()) AS Dias_En_Inventario, 
